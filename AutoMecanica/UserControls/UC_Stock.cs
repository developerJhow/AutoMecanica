...
namespace AutoMecanica.UserControls
{
    public partial class UC_Stock : UserControl
    {
        ...
        private void btnViewEstoque_Click(object sender, EventArgs e)
        {
            UC_StockTable ucTbl = new UC_StockTable();
            addUserControl(ucTbl);
        ...
        {
            UC_StockAdd uc = new UC_StockAdd();
            addUserControl(uc);
        }

        private void btnEditStock_Click(object sender, EventArgs e)
        {
            UC_StockEdit uc = new UC_StockEdit();
            addUserControl(uc);
        }
    }
}
